...
public class ChangeConfigAndRebootEngineTest extends ResourceActivitiTestCase {
    ...
    private boolean newExecutionRelationshipCountValue;
    ...
    protected void assertConfigProperty(boolean expectedValue) {
        PropertyEntity propertyEntity = managementService.executeCommand(commandContext -> commandContext.getPropertyEntityManager().findById(
