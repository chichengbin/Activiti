...
public class BoundaryTimerNonInterruptingEventTest extends PluggableActivitiTestCase {
    ...
    public void testMultipleTimersOnUserTask() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("nonInterruptingTimersOnUserTask");
        Task task1 = taskService.createTaskQuery().singleResult();
        assertThat(task1.getName()).isEqualTo("First Task");

        TimerJobQuery jobQuery = managementService.createTimerJobQuery().processInstanceId(processInstance.getId());
    ...
    public void testJoin() {
        ...
        // After process start, there should be 3 timers created
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("testJoin");
        Task task1 = taskService.createTaskQuery().singleResult();
    ...
    public void testTimerOnConcurrentTasks() {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("nonInterruptingOnConcurrentTasks");
    ...
    public void testTimerOnEmbeddedSubprocess() {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("nonInterruptingTimerOnEmbeddedSubprocess");
    ...
    public void testReceiveTaskWithBoundaryTimer() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("nonInterruptingCycle", variables);
    ...
    public void testTimerOnConcurrentSubprocess() {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("testTimerOnConcurrentSubprocess");
