...
public class DeleteReasonTest extends PluggableActivitiTestCase {
    ...
    public void testDeleteProcessInstance() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            ...
            assertHistoricActivitiesDeleteReason(processEngine, processInstance, null, "A");
            assertHistoricActivitiesDeleteReason(processEngine, processInstance, DeleteReason.PROCESS_INSTANCE_DELETED, "B", "C", "D");
        }
    }
    ...
    public void testDeleteProcessInstanceWithCustomDeleteReason() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            ...
            assertHistoricActivitiesDeleteReason(processEngine, processInstance, null, "A");
            assertHistoricActivitiesDeleteReason(processEngine, processInstance, customDeleteReason, "B", "C", "D");
        }
    }
    ...
    public void testRegularProcessInstanceEnd() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            ...
            assertHistoricActivitiesDeleteReason(processEngine, processInstance, null, "A", "B", "C", "D", "E");
        }
    }
    ...
    public void testDeleteProcessInstanceWithReceiveTask() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            ...
            assertHistoricActivitiesDeleteReason(processEngine, processInstance, null, "A");
            assertHistoricActivitiesDeleteReason(processEngine, processInstance, DeleteReason.PROCESS_INSTANCE_DELETED, "B", "C");
        }
    }
    ...
    public void testInterruptingBoundaryEvent() {
        ...
        assertHistoricActivitiesDeleteReason(processEngine, processInstance, null, "A");
        assertHistoricActivitiesDeleteReason(processEngine, processInstance, DeleteReason.BOUNDARY_EVENT_INTERRUPTING, "B", "C", "D", "theSubprocess");
    }
    ...
    public void testInterruptingBoundaryEvent2() {
        ...
        assertHistoricActivitiesDeleteReason(processEngine, processInstance, null, "A");
        assertHistoricActivitiesDeleteReason(processEngine, processInstance, DeleteReason.BOUNDARY_EVENT_INTERRUPTING, "B", "C", "theSubprocess");
    }
