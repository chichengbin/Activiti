...
public class TerminateEndEventTest extends PluggableActivitiTestCase {
    ...
    public void testProcessTerminate() throws Exception {
        ...
        assertHistoricTasksDeleteReason(processEngine, pi, null, "check before termination");
        assertHistoricTasksDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "check before end");
        assertHistoricActivitiesDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "preNormalTerminateTask");
        assertHistoricActivitiesDeleteReason(processEngine, pi, null, "preTerminateTask");
    }
    ...
    public void testTerminateWithSubProcess() throws Exception {
        ...
        assertHistoricTasksDeleteReason(processEngine, pi, null, "check before termination");
        assertHistoricTasksDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "check before end");
        assertHistoricActivitiesDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "preNormalEnd");
        assertHistoricActivitiesDeleteReason(processEngine, pi, null, "preTerminateEnd");
    }
    ...
    public void testTerminateWithSubProcess2() throws Exception {
        ...
        assertHistoricTasksDeleteReason(processEngine, pi, null, "check before termination", "check before end");
        assertHistoricActivitiesDeleteReason(processEngine, pi, null, "preNormalEnd", "preTerminateEnd");
        assertHistoricActivitiesDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "SubProcess_1");
    }
    ...
    public void testTerminateWithSubProcessTerminateAll() throws Exception {
        ...
        assertHistoricProcessInstanceDeleteReason(pi, DeleteReason.TERMINATE_END_EVENT);
        assertHistoricTasksDeleteReason(processEngine, pi, null, "check before end");
        assertHistoricTasksDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "check before termination");
        assertHistoricActivitiesDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "preTerminateEnd");
        assertHistoricActivitiesDeleteReason(processEngine, pi, null, "preNormalEnd");
    }
    ...
    public void testTerminateWithCallActivity() throws Exception {
        ...
        assertHistoricProcessInstanceDeleteReason(pi, DeleteReason.TERMINATE_END_EVENT);
        assertHistoricTasksDeleteReason(processEngine, pi, null, "check before termination");
        assertHistoricTasksDeleteReason(processEngine, subProcessInstance, DeleteReason.TERMINATE_END_EVENT, "Perform Sample");
        assertHistoricActivitiesDeleteReason(processEngine, pi, null, "preTerminateEnd");
        assertHistoricActivitiesDeleteReason(processEngine, subProcessInstance, DeleteReason.TERMINATE_END_EVENT, "task");
    }
    ...
    public void testTerminateInExclusiveGatewayWithMultiInstanceSubProcess() throws Exception {
        ...
        assertHistoricProcessInstanceDeleteReason(pi, DeleteReason.TERMINATE_END_EVENT);
        assertHistoricTasksDeleteReason(processEngine, pi, null, "check before termination");
        assertHistoricTasksDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "User Task");
        assertHistoricActivitiesDeleteReason(processEngine, pi, null, "preTerminateEnd");
        assertHistoricActivitiesDeleteReason(processEngine, pi, DeleteReason.TERMINATE_END_EVENT, "task");
    }
    ...
    public void testTerminateInSubProcessWithBoundary() throws Exception {
        ...
        waitForJobExecutorToProcessAllJobs(processEngine, 5000L, 25L);
