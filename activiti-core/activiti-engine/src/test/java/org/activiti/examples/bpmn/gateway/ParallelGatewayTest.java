...
public class ParallelGatewayTest extends PluggableActivitiTestCase {
    ...
    public void testUnbalancedForkJoin() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("UnbalancedForkJoin");
        TaskQuery query = taskService.createTaskQuery().processInstanceId(processInstance.getId()).orderByTaskName().asc();
